...
LLM_VERSION="facebook/MobileLLM-350M"
...
LLM_VERSION_CLEAN="${LLM_VERSION//\//_}"
PRETRAIN_RUN_NAME="Pretrain_Qwen2_baseline_${KEYWORD}"
...
FINETUNE_RUN_NAME="Finetune_Qwen2_baseline_${KEYWORD}"
